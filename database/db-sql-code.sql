...
--Create relationship between `clasification` and `invemtory` tables
...
--Add new table for contacting support
CREATE TABLE IF NOT EXISTS public.message_request
(
    message_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    message_firstname character varying NOT NULL,
    message_lastname character varying NOT NULL,
    message_email character varying NOT NULL,
    message_subject character varying NOT NULL,
    message_body text NOT NULL,
    message_status character varying NOT NULL DEFAULT 'Open',
    message_created_at timestamp without time zone NOT NULL DEFAULT now(),
    CONSTRAINT message_request_pkey PRIMARY KEY (message_id)
);
